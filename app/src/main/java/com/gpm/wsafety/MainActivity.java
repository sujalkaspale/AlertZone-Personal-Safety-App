...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnSafeZones = findViewById(R.id.btn_safe_zones);
        btnSafeZones.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Navigate to SafeZonesActivity
                Intent intent = new Intent(MainActivity.this, SafeZonesActivity.class);
    ...
    public void startServiceV(View view) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.SEND_SMS)
            ...
            multiplePermissions.launch(new String[]{Manifest.permission.SEND_SMS,Manifest.permission
